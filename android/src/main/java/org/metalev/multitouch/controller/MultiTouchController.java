...
public class MultiTouchController<T> {
    ...
    public static class PointInfo {
        ...
        private float dx, dy, diameter, diameterSq, angle;        private float[] xs = new float[MAX_TOUCH_POINTS];
        ...
        private boolean diameterSqIsCalculated, diameterIsCalculated, angleIsCalculated;        private float[] ys = new float[MAX_TOUCH_POINTS];
        // Event action code and event time
        private int action;
        private long eventTime;        private float[] pressures = new float[MAX_TOUCH_POINTS];
