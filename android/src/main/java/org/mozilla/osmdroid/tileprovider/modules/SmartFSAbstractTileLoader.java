...
class SmartFSAbstractTileLoader extends AbstractTileLoader {

    private final static String LOG_TAG = AppGlobals.makeLogTag(SmartFSAbstractTileLoader.class);
    private SmartFSProvider smartFSProvider;

    public SmartFSAbstractTileLoader(SmartFSProvider mapTileModuleProviderBase) {
