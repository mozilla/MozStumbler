 ...
 * @deprecated Use {@link org.mozilla.osmdroid.util.TileSystem} instead
 */
public class Mercator implements MapViewConstants {
     ...
     *
     * @param aLatE6 latitude in degrees [-89000000 to 89000000]
     * @param aLonE6 longitude in degrees [-180000000 to 180000000]
     * @param aZoom  zoom level
     * @param aReuse
