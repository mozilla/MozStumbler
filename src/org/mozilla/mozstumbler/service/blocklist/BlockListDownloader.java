...
public class BlockListDownloader {
    ...
    String getSha() {
        ...
        try {
            ...
            HttpGet get = new HttpGet("https://api.github.com/repos/anishgkanchan/MozStumbler/contents/res/blocklists/BlockList.txt");
    ...
    boolean getFile() {
        ...
        try {
            ...
            URL url = new URL("https://raw.githubusercontent.com/anishgkanchan/MozStumbler/master/res/blocklists/BlockList.txt");
