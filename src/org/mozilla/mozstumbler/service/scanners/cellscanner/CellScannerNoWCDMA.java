...
import org.mozilla.mozstumbler.client.DefaultCellScanner;
...
public class CellScannerNoWCDMA implements CellScanner.CellScannerImpl {
    ...
    protected static final String LOGTAG = DefaultCellScanner.class.getName();
...
//               cells.add(cell); TODO: handle LTE
//               added = true;
//            }
        }
        return added;
